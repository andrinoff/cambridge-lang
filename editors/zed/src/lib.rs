            ...
            .unwrap_or(false)
        {
            ...
            let download_url = match (platform, arch) {
                (zed::Os::Mac, zed::Architecture::Aarch64) =>
                    "https://github.com/andrinoff/cambridge-lang/releases/download/v0.1.1/cambridge-lsp-macos-arm64",
                (zed::Os::Mac, zed::Architecture::X8664) =>
                    "https://github.com/andrinoff/cambridge-lang/releases/download/v0.1.1/cambridge-lsp-macos-intel",
                (zed::Os::Linux, _) =>
                    "https://github.com/andrinoff/cambridge-lang/releases/download/v0.1.1/cambridge-lsp-linux",
                (zed::Os::Windows, _) =>
                    "https://github.com/andrinoff/cambridge-lang/releases/download/v0.1.1/cambridge-lsp.exe",
